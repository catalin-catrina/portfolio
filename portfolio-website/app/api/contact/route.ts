...
export async function POST(request: Request) {
  try {
    ...
    await resend.emails.send({
      from: process.env.CONTACT_FROM!,   // e.g. "Portfolio <hello@send.catalincatrina.com>"
      to: [process.env.CONTACT_TO!],     // your Outlook address
    ...
    await resend.emails.send({
      from: process.env.CONTACT_FROM!,  // same sending address
